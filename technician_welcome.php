...
<img src="images/img0008.png" id="Shape3" alt="" style="width:1900px;height:1319px;"></div>
...
<li style="float:right;"><a role="menuitem" href="technician_logout.php" title="Log Out"><i class="fa fa-user fa-2x">&nbsp;</i><br>Log&nbsp;Out</a></li>
...
<div id="big-container" class="container">
   <div id="navopt" class="container">
    <ul id="navopt">
       <li><a onclick="showPageClientRequest(this);" id="navoptmenu1">Client's Request</a></li>
       <li><a id="navoptmenu2" onclick="showPageRequestStatus(this);" id="navoptmenu">Appointment List</a>
        <li><a id="navoptmenu2" onclick="showPageRequestHardware(this);" id="navoptmenu" onclick="showPageRequestStatus(this)">Hardware Request</a>   
       <li><a id="navoptmenu4">Status History</a></li>
       <li><a id="navoptmenu5">User Profile</a></li>
       </ul>
    </div>
    <div class="emptypage">
    <embed id="embedpage" type="text/html" src="./technician_client_request.php" style="width: 100%;
            height: 100%;">
</div>
</div>
    <script type="text/javascript">
        
    function showPageClientRequest(whichpage){
  var source=whichpage.getAttribute("href");
  var page=document.getElementById("embedpage");
  var clone=page.cloneNode(true);
  clone.setAttribute('src', 'technician_client_request.php');
  ...
  var page=document.getElementById("embedpage");
  var clone=page.cloneNode(true);
  clone.setAttribute('src', 'appointmentlist.php');
  page.parentNode.replaceChild(clone,page)
}
        function showPageRequestHardware(whichpage){
  var source=whichpage.getAttribute("href");
  var page=document.getElementById("embedpage");
  var clone=page.cloneNode(true);
  clone.setAttribute('src', 'requesthardware.php');
  page.parentNode.replaceChild(clone,page)
}
</script>
     <!-- END OF CONTENT-->
